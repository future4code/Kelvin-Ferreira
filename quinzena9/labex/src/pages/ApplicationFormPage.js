...
import ApplicationBackground from '../visuals/ApplicationBackground.png'
import ApplicationTitle from '../visuals/ApplicationTitle.png'

const ApplicationContainer = styled.div`
    text-align: center;
    background-image: url(${ApplicationBackground});
...
export function ApplicationFormPage() {
    ...
    const userApplication = (e) => {
        ...
        axios.post(
            `https://us-central1-labenu-apis.cloudfunctions.net/labeX/kelvin-ferreira-munoz/trips/${planetId}/apply`,
            forms,
            {
                headers: {
            ...
            alert('Ocorreu um erro ao tentar se candidatar :(')
        })
    }
    ...
    return (
        <ApplicationContainer>
            ...
            <Form onSubmit={userApplication}>
                ...
                <Select name={'country'} value={forms.country} onChange={onChange}>
